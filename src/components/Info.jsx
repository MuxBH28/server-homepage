...
export default function Info({ isOpen, onClose }) {
    ...
    return (
        ...
        >
            <div className="bg-black/80 backdrop-blur-lg text-gray-100 rounded-xl p-6 w-full max-w-4xl shadow-lg border border-white/10 relative flex flex-col space-y-6 overflow-y-auto max-h-[90vh]">
                <button
                    onClick={onClose}
                ...
                <p className="text-gray-400 text-sm sm:text-base mb-5 text-center sm:text-left">
                    ...
                    <span className="italic">
                        ...
                        As for the name “Server Homepage”... yeah, I know — it's pretty basic and generic. One day it might get a new name, but for now, it stays as it is.
